...
class LineExists : public ::Ice::UserExceptionHelper<LineExists, ::Ice::UserException>
{
public:

    virtual ~LineExists();

    LineExists(const LineExists&) = default;
...
/// \cond INTERNAL
static LineExists _iceS_LineExists_init;
/// \endcond

class StopExists : public ::Ice::UserExceptionHelper<StopExists, ::Ice::UserException>
{
public:

    virtual ~StopExists();

    StopExists(const StopExists&) = default;
...
public:
    ...
    {
        return _makeLamdaOutgoing<::std::string>(std::move(response), std::move(ex), std::move(sent), this, &SIP::StopPrx::_iceI_getName, context);
    }
...
class LineExists : public ::Ice::UserException
{
public:
     ...
     */
    virtual LineExists* ice_clone() const;
    /**
...
class StopExists : public ::Ice::UserException
{
public:
     ...
     * @return A shallow copy of this exception.
     */
    virtual StopExists* ice_clone() const;
    /**
     * Throws this exception.
     */
    virtual void ice_throw() const;
 ...
 * IceProxy::SIP::Stop::begin_getName.
 * Create a wrapper instance by calling ::SIP::newCallback_Stop_getName.
 */
...
public:
    ...
    ::Ice::AsyncResultPtr begin_getName(const ::SIP::Callback_Stop_getNamePtr& cb, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_getName(::Ice::noExplicitContext, cb, cookie);
    }

    ::Ice::AsyncResultPtr begin_getName(const ::Ice::Context& context, const ::SIP::Callback_Stop_getNamePtr& cb, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_getName(context, cb, cookie);
    }
...
template<>
struct StreamableTraits< ::SIP::LineExists>
{
    static const StreamHelperCategory helper = StreamHelperCategoryUserException;
};

template<>
struct StreamableTraits< ::SIP::StopExists>
{
    static const StreamHelperCategory helper = StreamHelperCategoryUserException;
};
 ...
 * @return An object that can be passed to an asynchronous invocation of IceProxy::SIP::Stop::begin_getName.
 */
