...
const ::std::string iceC_SIP_Stop_ids[2] =
{
    "::Ice::Object",
    "::SIP::Stop"
};
const ::std::string iceC_SIP_Stop_ops[] =
{
    "getName",
    "ice_id",
    "ice_ids",
...
const ::std::string iceC_SIP_Stop_getName_name = "getName";

const ::IceInternal::DefaultUserExceptionFactoryInit<::SIP::LineExists> iceC_SIP_LineExists_init("::SIP::LineExists");

const ::IceInternal::DefaultUserExceptionFactoryInit<::SIP::StopExists> iceC_SIP_StopExists_init("::SIP::StopExists");
...
SIP::LineExists::~LineExists()
{
}

const ::std::string&
SIP::LineExists::ice_staticId()
{
    static const ::std::string typeId = "::SIP::LineExists";
    return typeId;
}

SIP::StopExists::~StopExists()
{
}

const ::std::string&
SIP::StopExists::ice_staticId()
{
    static const ::std::string typeId = "::SIP::StopExists";
    return typeId;
}

bool
SIP::Stop::ice_isA(::std::string s, const ::Ice::Current&) const
{
    return ::std::binary_search(iceC_SIP_Stop_ids, iceC_SIP_Stop_ids + 2, s);
}

::std::vector<::std::string>
SIP::Stop::ice_ids(const ::Ice::Current&) const
{
    return ::std::vector<::std::string>(&iceC_SIP_Stop_ids[0], &iceC_SIP_Stop_ids[2]);
}

::std::string
SIP::Stop::ice_id(const ::Ice::Current&) const
{
    return ice_staticId();
}

const ::std::string&
SIP::Stop::ice_staticId()
{
    static const ::std::string typeId = "::SIP::Stop";
    return typeId;
}

/// \cond INTERNAL
bool
SIP::Stop::_iceD_getName(::IceInternal::Incoming& inS, const ::Ice::Current& current)
{
...
/// \cond INTERNAL
bool
SIP::Stop::_iceDispatch(::IceInternal::Incoming& in, const ::Ice::Current& current)
{
    ::std::pair<const ::std::string*, const ::std::string*> r = ::std::equal_range(iceC_SIP_Stop_ops, iceC_SIP_Stop_ops + 5, current.operation);
    if(r.first == r.second)
    {
        throw ::Ice::OperationNotExistException(__FILE__, __LINE__, current.id, current.facet, current.operation);
    }

    switch(r.first - iceC_SIP_Stop_ops)
    {
        case 0:
        {
...
/// \cond INTERNAL
void
SIP::StopPrx::_iceI_getName(const ::std::shared_ptr<::IceInternal::OutgoingAsyncT<::std::string>>& outAsync, const ::Ice::Context& context)
{
    _checkTwowayOnly(iceC_SIP_Stop_getName_name);
    outAsync->invoke(iceC_SIP_Stop_getName_name, ::Ice::OperationMode::Normal, ::Ice::FormatType::DefaultFormat, context,
        nullptr,
        nullptr);
}
/// \endcond
...
SIP::StopPrx::_newInstance() const
{
...
#else
SIP::LineExists::~LineExists() throw()
{
}
#endif

::std::string
SIP::LineExists::ice_id() const
{
    return "::SIP::LineExists";
}

SIP::LineExists*
SIP::LineExists::ice_clone() const
{
    return new LineExists(*this);
}

void
SIP::LineExists::ice_throw() const
{
    throw *this;
}
...
/// \cond STREAM
void
SIP::LineExists::_writeImpl(::Ice::OutputStream* ostr) const
{
    ostr->startSlice("::SIP::LineExists", -1, true);
    ::Ice::StreamWriter< LineExists, ::Ice::OutputStream>::write(ostr, *this);
    ostr->endSlice();
}

void
SIP::LineExists::_readImpl(::Ice::InputStream* istr)
{
    istr->startSlice();
    ::Ice::StreamReader< LineExists, ::Ice::InputStream>::read(istr, *this);
    istr->endSlice();
}
/// \endcond
...
#else
SIP::StopExists::~StopExists() throw()
{
}
#endif

::std::string
SIP::StopExists::ice_id() const
{
    return "::SIP::StopExists";
}

SIP::StopExists*
SIP::StopExists::ice_clone() const
{
    return new StopExists(*this);
}

void
SIP::StopExists::ice_throw() const
{
    throw *this;
}
...
/// \cond STREAM
void
SIP::StopExists::_writeImpl(::Ice::OutputStream* ostr) const
{
    ostr->startSlice("::SIP::StopExists", -1, true);
    ::Ice::StreamWriter< StopExists, ::Ice::OutputStream>::write(ostr, *this);
    ostr->endSlice();
}

void
SIP::StopExists::_readImpl(::Ice::InputStream* istr)
{
    istr->startSlice();
    ::Ice::StreamReader< StopExists, ::Ice::InputStream>::read(istr, *this);
    istr->endSlice();
}
/// \endcond

/// \cond INTERNAL
::IceProxy::Ice::Object* ::IceProxy::SIP::upCast(Stop* p) { return p; }

void
::IceProxy::SIP::_readProxy(::Ice::InputStream* istr, ::IceInternal::ProxyHandle< Stop>& v)
{
    ::Ice::ObjectPrx proxy;
    istr->read(proxy);
    if(!proxy)
...
::Ice::AsyncResultPtr
IceProxy::SIP::Stop::_iceI_begin_getName(const ::Ice::Context& context, const ::IceInternal::CallbackBasePtr& del, const ::Ice::LocalObjectPtr& cookie, bool sync)
{
    _checkTwowayOnly(iceC_SIP_Stop_getName_name, sync);
    ::IceInternal::OutgoingAsyncPtr result = new ::IceInternal::CallbackOutgoing(this, iceC_SIP_Stop_getName_name, del, cookie, sync);
    try
    {
        result->prepare(iceC_SIP_Stop_getName_name, ::Ice::Normal, context);
        result->writeEmptyParams();
        result->invoke(iceC_SIP_Stop_getName_name);
    }
...
::std::string
IceProxy::SIP::Stop::end_getName(const ::Ice::AsyncResultPtr& result)
{
    ::Ice::AsyncResult::_check(result, this, iceC_SIP_Stop_getName_name);
    ::std::string ret;
...
/// \cond INTERNAL
::IceProxy::Ice::Object*
IceProxy::SIP::Stop::_newInstance() const
{
    return new Stop;
}
/// \endcond
...
const ::std::string&
IceProxy::SIP::Stop::ice_staticId()
{
    return ::SIP::Stop::ice_staticId();
}
...
/// \cond INTERNAL
::Ice::Object* SIP::upCast(Stop* p) { return p; }
...
bool
SIP::Stop::ice_isA(const ::std::string& s, const ::Ice::Current&) const
{
    return ::std::binary_search(iceC_SIP_Stop_ids, iceC_SIP_Stop_ids + 2, s);
}
...
namespace
{
const ::std::string iceC_SIP_Stop_all[] =
{
    "getName",
    "ice_id",
    "ice_ids",
...
SIP::Stop::_iceDispatch(::IceInternal::Incoming& in, const ::Ice::Current& current)
{
    ::std::pair<const ::std::string*, const ::std::string*> r = ::std::equal_range(iceC_SIP_Stop_all, iceC_SIP_Stop_all + 5, current.operation);
    if(r.first == r.second)
    {
        throw ::Ice::OperationNotExistException(__FILE__, __LINE__, current.id, current.facet, current.operation);
    }

    switch(r.first - iceC_SIP_Stop_all)
    {
        case 0:
        {
            return _iceD_getName(in, current);
...
/// \cond STREAM
void
SIP::Stop::_iceWriteImpl(::Ice::OutputStream* ostr) const
{
...
void
SIP::Stop::_iceReadImpl(::Ice::InputStream* istr)
{
    istr->startSlice();
...
/// \cond INTERNAL
void
SIP::_icePatchObjectPtr(StopPtr& handle, const ::Ice::ObjectPtr& v)
{
